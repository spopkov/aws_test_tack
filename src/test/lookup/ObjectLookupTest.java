...
public class ObjectLookupTest {
    ...
    public void testAwsLookup() {
        ...
        List<? extends AwsObject> filteredAwsObjects = new ObjectLookup().findAwsObjectsWithProperties(allAwsObjects, propertyMap);
        ...
        filteredAwsObjects.forEach(awsObject -> {
            ...
            propertyMap.keySet().forEach(key ->
                    this.softAssert.assertEquals(getFromMap(propsToMap(awsObject), key), propertyMap.get(key)));
        });
